...
class Index extends crearHtml{
    ...
    public $_subTitulo = 'Información sobre el curso';
    public $_datos = '';
    public $Table = 'cursos';
   ...
   /**
    ...
    function listaClases(){
        ...
        $sql = 'SELECT nombre,id_cursos FROM capitulos WHERE id_cursos = '.$this->idCurso;
        ...
        $html .= '<div class="col-md-4">
                                <div class="panel">
                                    ...
                                    foreach($clases as $c){
                                        $html .= '<h2><a href="forum.php?id='.$c['id_cursos'].'">'. $c['nombre'] . '</a></h2><hr>';
                                    }
    ...
    function informacionEstado(){
        ...
        $html .= '  <div class="col-md-4">
                     ...
                     <div class="panel-body"> 
                        ...
                        Este curso caduca: Agosto 19 2015<span class="btn btn-info"><a href="evaluacion.php">Realizar evaluaci&oacuten</a></span>
