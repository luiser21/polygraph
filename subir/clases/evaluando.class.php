   ...
   /**
    ...
    function evaluacion(){
        ...
        $sql = "SELECT p.id_preguntas,p.descripcion pregunta, rp.descripcion respuesta, rp.correcta ,rp.id_respuestas_preguntas
                ...
                INNER JOIN preguntas p ON p.id_evaluacion = ec.id_evaluacion and ec.id_evaluacion = ".$_POST['mi_evaluacion']." 
        ...
        <div class="col-md-6">
                        <div class="panel panel-info">
                            ...
                            ';
                             ...
                             $html .= '<h1>Felicitaciones, Tu certificado ya está disponible </h1>
