   ...
   */ 
   ...
   function Contenido(){
    ...
    $sql = "SELECT
            ...
            INNER JOIN
              plantas P ON P.id_planta = S.id_secciones
            WHERE
                        ...
                        <div class="panel panel-default panelCrear">
                            ...
                            <div class="panel-body">
                                <form id="formCrear" role="form" enctype="multipart/form-data">
                                    ...
                                    <button type="button" id="guardarCurso" class="btn btn-primary">Duplicar Equipo</button>
     ...
     * @return void
     */
    function insertaMecanismos( $data , $idComponente ){
        $sql = "
        INSERT
        INTO
          `mecanismos`(
     ...
     * @return void
     */
    function getMecanismos($idComponente){
        $sql = "
            SELECT
               id_mecanismos,
              `codigoempresa`,
     ...
     * @return void
     */
    function insertaMecMet($data,$idMecanismo){
                $sqlMecMet = "INSERT
                            INTO
                                `id_mecanismos`,
                                  `id_metodos`,
        ...
        $this->QuerySql($sqlMecMet);  
             ...
             /** INNER JOIN
  componentes AS c ON C.id_equipos = E.id_equipos
INNER JOIN
  mecanismos M ON M.id_componente = C.id_componentes
INNER JOIN
  mec_met MM ON MM.id_mecanismos = M.id_mecanismos
WHERE*/
    }
     ...
     * @return
     */
    function getMecMet($idMecanismo){
        "
        SELECT 
          MM.`id_mecanismos`,
          MM.`id_metodos`,
        ...
        FROM
         mec_met AS MM
         WHERE E.id_mecanismos = ".$idMecanismo;
  ...
  return $this->Consulta($sql);
    ...
    function duplicarMecanismos( $idComponenteAntiguo , $idComponenteNuevo ){
        $arrMecanismos = $this->getMecanismos($idComponenteAntiguo);
        foreach($arrMecanismos as $Mecanismos){
            $this->insertaMecanismos( $Mecanismos , $idComponenteNuevo );
    ...
    function duplicarMecMet($idMecanismoAntiguo,$idMecanismoNuevo){
        $arrMecMet = $this->getMecMet($idMecanismoAntiguo);
        foreach($arrMecMet as $MecMet){
            $this->insertaMecMet( $MecMet , $idMecanismoNuevo );
        } 
    ...
    function guardarDatos(){
        imprimir($this->_datos);
         ...
         echo 'Equipo Duplicado de forma exitosa';      
    }
