 ...
 * @access public
 */
class exportarotscerradas extends crearHtml{
    
    public $_titulo = 'GENERAR INFORMES OTS CERRADAS';
            ...
            <div class="col-md-8">
                        <div class="panel panel-default panelCrear">
                            <div class="panel-heading">
                                <h3 class="panel-title">OTS CERRADAS</h3>
                            ...
                            <div class="panel-body">
                                <form  id="formCrear" role="form" method="post" action="exportarotsinforme.php">
