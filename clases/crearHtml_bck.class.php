    ...
    function menuAdmin(){
        ...
        $html = '<li class="nav-dropdown">
                            <a href="#" title="UI Elements">
                                <i class="fa  fa-fw fa-cogs"></i> ADMINISTRACI&Oacute;N
                            </a>
                            <ul class="nav-sub">
                                <li>
                                ...
                                <li>
                                    <a href="equipos.php" title="Subir Equipos">
                                         Equipos
                                    </a>
                                </li>
                         ...
                         <li class="nav-dropdown  '.$open.'">
                            ...
                            <ul class="nav-sub">
                                <li>
                                 ...
                                 <li>
                                    <a href="cargar_imagenes.php" title="Subir Imagenes Equipos">
                                         Subir Imagenes Equipos
                                    </a>
                                </li> 
                                 <li>
                        ...
                        <li class="nav-dropdown  '.$open.'">
                            ...
                            <ul class="nav-sub">
                                ...
                                <li><a href="#" title="Cerrar ot">Cerrar Ot</a>
                                </li>                                
                            </ul>
                        </li>';
                        }
                        ...
                        <li class="nav-dropdown  '.$open.'">
                            ...
                            <ul class="nav-sub">
                                <li><a href="reportes.php" title="Informes">Imprimir Cartas</a>
                                </li>
                    ...
                    ';
                        ...
                        <li class="nav-dropdown  '.$open.'">
                            ...
                            <ul class="nav-sub">
                                <li><a href="informes.php" title="Informes">Generar Informes</a>
                                </li>
...
47,48,49,50,51)";*/
    ...
    function barraProfile(){
        ...
        $html = '       
                <div class="sidebar-profile">
                    <div class="avatar">
                        <img class="img-circle profile-image" src="'.$this->fotoUsuario.'" alt="profile" width="65" height="65">
    ...
    function _header(){
        $html = ' <header id="header">
            <!--logo start-->
            <div class="brand">
            <a href="#" class="pull-left" style="padding: 6%">
...
/**
  <li class="dropdown profile hidden-xs">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="meta">
                            <span class="avatar">
                                <img src="assets/img/LuisCa.jpg" class="img-circle" alt="">
                            </span>
                        <span class="text">'.$this->NombreUsuario.'</span>
