                            ...
                            <div class="panel-body">
                                <form id="formCrear" role="form">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <button type="button" id="guardarMecMet" class="btn btn-primary">Guardar Mecanismo e Ingresar Programaci&oacute;n</button>
...
//                            );        
    ...
    function runEliminar(){
        $sql = ' DELETE MM, M FROM `mec_met` MM 
                 INNER JOIN mecanismos M ON M.id_mecanismos = MM.id_mecanismos 
                 WHERE M.id_mecanismos =' . $this->_datos;
        $this->QuerySql($sql);
