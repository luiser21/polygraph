 ...
 * @access public
 */
class aplicaciones extends crearHtml{
    
    public $_titulo = 'ADMINISTRAR TABLA APLICACIONES';
    public $_subTitulo = 'Crear Aplicacion';
    public $_datos = '';
    public $Table = 'aplicaciones_lub';
    public $PrimaryKey = 'id_aplicacion';
   ...
   function Contenido(){
    ...
    $_tipo = array();
    array_push($_tipo, array( 'codigo' => 'Aceite', 'descripcion' => 'Aceite') );
    array_push($_tipo, array( 'codigo' => 'Grasa', 'descripcion' => 'Grasa') );
                            ...
                            <div class="panel-body">
                                <form id="formCrear" role="form">
                                    ...
                                    <div class="form-group">
                                        <label for="nombre">Aplicaiones:</label>
                                        '.
                                        
                                        $this->create_input('text','aplicacion','aplicacion','Nombre de la clasificacion',false,'form-control required').
         ...
         $html .= '</select>';
                                  ...
                                  $html .=' </div>'; 
                                    if(	$_SESSION["tipo_usuario"]<>3){
                                         $html.='<button type="button" id="guardarCurso" class="btn btn-primary">Guardar Aplicacion</button>';
                                    }
