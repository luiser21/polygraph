<?php
class tareas extends crearHtml{
    
    public $_titulo = 'ADMINISTRAR TABLA TAREAS';
    public $_subTitulo = 'Crear Tarea';
    public $_datos = '';
    public $Table = 'tareas';
    public $PrimaryKey = 'id_tareas';
                            ...
                            <div class="panel-body">
                                <form id="formCrear" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        $this->create_input('text','descripcion','descripcion','Nombre de la tarea',false,'form-control required').
                                    ...
                                    if(	$_SESSION["tipo_usuario"]<>3){
                                         $html.='<button type="button" id="guardarCurso" class="btn btn-primary">Guardar tarea</button>';
                                    }
