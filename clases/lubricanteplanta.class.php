 ...
 * @access public
 */
class lubricanteplanta extends crearHtml{
    
    public $_titulo = 'GENERAR INFORMES LUBRICANTES POR PLANTA';
            ...
            <div class="col-md-8">
                        <div class="panel panel-default panelCrear">
                            <div class="panel-heading">
                                <h3 class="panel-title">LUBRICANTES POR PLANTA</h3>
                            ...
                            <div class="panel-body">
                                <form  id="formCrear" role="form" method="post" action="lubricanteplanta_informe.php">
