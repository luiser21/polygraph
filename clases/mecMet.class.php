...
class mecMet extends crearHtml{
   ...
   function Contenido(){
                            ...
                            <div class="panel-body">
                                ...
                                '; 
                                    if(	$_SESSION["tipo_usuario"]<>3){
                                         $html.='<button type="button" id="guardaMecMet" class="btn btn-primary">Guardar Programaci&oacute;n</button>';                                                                                                       
                                    }
     ...
     */
    function getDatos(){
        $sql = 'SELECT `id_mec_met`, `id_mecanismos`, `id_metodos`, `id_tareas`, `id_frecuencias`, `id_aplicacion`, `minutos_ejecucion`, `puntos`, `id_unidad_cant`, `id_simbologia`, `cod_lubricante`,`cantidad` FROM '.$this->Table .' WHERE '.$this->PrimaryKey.' = '.$this->_datos;
